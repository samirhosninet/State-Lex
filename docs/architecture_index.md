# Shadow State — Master Architecture Index

**Single Source of Truth** for navigating the ratified Architecture Freeze Package (v1.0.0).
...
- 🔌 [Canonical Port Contracts](port_contracts.md) — Standardized TypeScript application interface contracts
- 📖 [Glossary](glossary.md) — Unified domain & technical terminology definitions
...
- 🔹 [ADR-002: Seed-Based Deterministic PRNG](adr/ADR-002-seeded-prng-determinism.md)
- 🔹 [ADR-003: Asynchronous LLM Isolation](adr/ADR-003-async-llm-isolation.md)
- 🔹 [ADR-004: Fixed-Point Integer Arithmetic](adr/ADR-004-fixed-point-arithmetic.md)
- 🔹 [ADR-005: Atomic Persistence Writes & Storage Fallback](adr/ADR-005-atomic-persistence-fallback.md)
